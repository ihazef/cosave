	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				...
				$qry = $conn->query("SELECT *,l.amount as loani,sum(p.amount) as tot,l.id as lid,l.ref_no,b.status,concat(b.lastname,', ',b.firstname,' ',b.middlename)as name,
				b.contact_no,  b.address from borrowers b inner join loan_list l on l.borrower_id = b.id  inner join payments p
				 on l.id=p.loan_id where l.status=1 order by b.id asc");
						 ...
						 <tr>
						 	...
						 	<td><a href="index.php?page=list?l_id=<?php echo $row['lid'] ?>">
