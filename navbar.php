...
<nav id="sidebar" class='mx-lt-5 bg-white' >
 ...
 Visit website : www.mayurik.com -->  
		<div class="sidebar-list">
				...
				<a href="index.php?page=ingoboka" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-money-dollar"></i></span> Ingoboka</a>
				<a href="shares.php" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-money-dollar"></i></span> Shares</a>
				...
				<a href="index.php?page=borrowers" class="nav-item nav-borrowers"><span class='icon-field'><i class="fa fa-user-friends"></i></span>Active Member</a>
				<a href="index.php?page=delborrowers" class="nav-item nav-borrowers"><span class='icon-field'><i class="fa fa-user-friends"></i></span>Removed Member</a>
